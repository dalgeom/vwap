"""
TASK-SIMPLE-003: Condition 1 단독 P&L 검증
...
def main() -> None:
    ...
    out_path = RESULT_DIR / f"simple_cond1_pnl_{ts}.json"
    ...
    print()
    print("=" * 62)
    print("TASK-SIMPLE-003: Condition 1 P&L (1.0xATR, no other conds)")
