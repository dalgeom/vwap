...
> ⚠️ **구조적 위험 경고 — F 附記 (결정 #38, 2026-04-24)**
>
> | 모듈 | 상태 | 일평균 | EV |
> |---|---|---|---|
> | Module A Long | 포기 확정 | 0건 | — |
> | Module A Short | DEP-MOD-A-001 보류 | 0건 | — |
> | Module B Long (BTC/ETH/SOL/BNB) | ✅ 사용자 오버라이드 확정 | 1.445건/일 | +0.776~0.889 ATR |
> | Module B Short | S3 보류 (EV 구조적 한계) | 0건 | — |
> | **현재 합산** | **B Long 4종 운용 개시** | **1.445건/일** | — |
>
> **편입 확정 심볼 (결정 #40, 2026-04-25)**: BTC / ETH / SOL / BNB
> 합산 빈도: **1.445건/일** (철칙 2건 대비 72.3% — 결정 #42 사용자 오버라이드 확정)
> MDD 기준: BTC ≤ 15% / 알트코인 ≤ 25% (결정 #40)
> ✅ Walk-Forward 검증 완료 (2026-04-27): BTC 1.39 / ETH 1.36 / SOL 1.29 / BNB 2.53 — 전원 PASS (결정 #43)
> ✅ Stage 1 게이트 통과 확정 (결정 #43, 2026-04-27)
> 잔여 과제: Testnet 실거래 체크리스트 집행 → Module A 재설계 또는 B Short S3 재접근으로 잔여 0.555건/일 확보.

> ---
> **현황 업데이트 (2026-04-30, 결정 #47~#79 반영)**
>
> | 전략 | 상태 | 일평균 | EV |
> |---|---|---|---|
> | Module B Long (유니버스 전체 자동 스캔) | ✅ LIVE (Demo) | ~1.721건/일 | +검증완료 |
> | 4H Swing Breakout (Cat.2) | ✅ LIVE (Demo) | ~0.209건/일 | +검증완료 |
> | Module B Short | 장기 보류 | 0건 | — |
> | S-01 (4H Swing + 15m Pullback) | ❌ 드롭 (결정 #79, 2026-04-30) | — | gross EV 음수, gross EV 음수 전략 재설계 불가 선례 |
> | Short V-01 / V-02 | 장기 보류 | 0건 | — |
> | **현재 합산** | **2전략 LIVE** | **1.930건/일** | — |
>
> 목표: 2.0건/일 / **갭: 0.07건/일**
> 다음 탐구: **Cat.9 유동성 사냥 착수 (결정 #80, 2026-04-30)** — WF 결과 후 Cat.7/Cat.8 재판단
