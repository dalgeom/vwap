...
> | Module B Long (BTC) | ✅ 확정 | 0.374건/일 | +0.799 ATR |
> | Module B Long (ETH) | 검증 중 (MDD 초과 재검증) | — | — |
> | Module B Long (SOL/BNB) | 데이터 수집 중 | — | — |
> | Module B Short | S4 보류 | 0건 | — |
> | **현재 합산** | **B Long BTC만** | **0.374건/일** | — |
>
> **편입 확정 심볼 (결정 #40, 2026-04-25)**: BTC / ETH / SOL / BNB
> 합산 빈도: **1.445건/일** (철칙 2건 대비 72.3%)
> MDD 기준: BTC ≤ 15% / 알트코인 ≤ 25% (결정 #40)
> 잔여 과제: Module B Short S3 또는 Module A 재설계로 잔여 0.555건/일 확보 필요.
